class InductionRequestId {
  ...
  factory InductionRequestId.fromJson(Map<String, dynamic> json) {
    return InductionRequestId(
  ...
  String get idrequest => id.toString(); // Menggunakan fullName dari API
