...
class _ApprovedMailScreenState extends State<ApprovedMailScreen> {
  ...
  Future<void> _sendApprovalRequest(int idrequest) async {
    setState(() {
      isLoading = true;
      approvalMessage = 'Processing...';  // Indicate the request is being processed
    });

    try {
      String responseMessage = await ApiService().sendApprovalRequest(idrequest);
      setState(() {
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: approvalMessage.contains('successfully') ? Colors.green : Colors.red,
                  ),
