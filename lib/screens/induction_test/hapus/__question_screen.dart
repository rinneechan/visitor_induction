                              ...
                              children: [
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: selectedOptionIndex != null
                                            ? Color(
                                                0xFF07840B) // Hijau jika pilihan dipilih
                                            : Colors
                                                .grey, // Abu-abu jika tidak ada pilihan
                                        borderRadius:
                                ...
                                if (incorrectCount == 3) ...[
                                  Center(
                                    ...
                                    //         Image.asset('assets/images/groupOfHeart3.png',
                                    //           height: 40.0,
                                    ...
                                    //         Text('You\'ve lost all your hearts. Please start over.',
                                    //           style: TextStyle(
                                    //             color: Color(0xFF343434),
                                    //             fontFamily: 'Hanken Grotesk',
                                    //             fontSize: 20.0,
                                    ...
                                    //           },
                                    //           style: ElevatedButton.styleFrom(
                                    //             backgroundColor: const Color(0xFF8F0B0B), // Warna latar belakang merah
                                    //             shape: RoundedRectangleBorder(
                                    //               borderRadius: BorderRadius.circular(8), // Border radius 8px
                                    //             ),
                                    //             padding: const EdgeInsets.symmetric(vertical: 16), // Padding atas dan bawah
                                    //             minimumSize: const Size(double.infinity, 56), // Stretch button ke lebar penuh dengan tinggi 56px
                                    //             elevation: 2, // Efek bayangan ringan
                                    //           ),
                                    //           child: const Text(
                                    //             'Start Over',
                                    //             style: TextStyle(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.only(
                                          top: 100.0), // Jarak 100px dari atas
                                      child: Dialog(
                                        shape: RoundedRectangleBorder(
                                          borderRadius:
