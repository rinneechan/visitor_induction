...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      debugPrint("✅ Masuk ke onMessageOpenedApp: ${message.data}");
      ...
      if (message.data.containsKey('route')) {
        ...
        Future.delayed(Duration(milliseconds: 500), () {
          globalNavigatorKey.currentState?.pushNamed(route, arguments: message.data);
        });
      } else {
  ...
  Future<void> initNotifications() async {
    try {
      ...
      FirebaseMessaging.onMessage.listen((RemoteMessage message) {
        ...
        debugPrint("globalNavigatorKey: ${globalNavigatorKey.currentState}");
      ...
      //       );
      //     } else {
      //       debugPrint("❌ Action tidak dikenali: $action");
      //     }
      //   }
      // });
  ...
  try {
    ...
    if (message.data.containsKey('type')) {
      ...
      switch (type) {
        ...
        default:
          globalNavigatorKey.currentState?.pushNamed('/main-menu');
          break;
      }
    } else {
      debugPrint("❌ Notifikasi tidak memiliki tipe yang dikenali.");
    }
  } catch (e) {
